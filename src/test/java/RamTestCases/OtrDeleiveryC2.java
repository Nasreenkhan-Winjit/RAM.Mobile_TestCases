...
public class OtrDeleiveryC2 {
	...
	@Test(description= "Deliver with rule No7 Invalid case",priority= 2)
	...
	@Test(description= "Validate OTP field with invalid case",priority= 3)
	...
	@Test(description= "Delivery with Rule No7Step3 Valid OTP",priority= 4)

	public void DeliverywithRuleNo7Step3ValidOTP() throws InterruptedException {	

		driver.findElementById("com.ram.courier:id/et_otp").sendKeys("12146");
	...
	@Test(description= "GRV Delivery cover rule 5 and 6",priority= 5)
	...
	//Validate Back Btn
	@Test(description= "Validate Back Button",priority= 6)
	...
	@Test(description= "GRV Delivery Rule 5",priority= 7)
	...
	// WithRule No.1and 3
	@Test(description= "Delivery Rule 1 and 3 ",priority= 8)
	...
	@Test(description= "PAXI Invalid Case",priority= 9)
	...
	@Test(description= "PAXI valid with 14 and 19",priority= 10)
	...
	@Test(description= "Knock n Drop rule 12 invalid",priority= 11)
	...
	@Test(description= "Knock n Drop rule 12 invalid",priority= 12)
